package com.smart.view.routeview.test;
...
import com.smart.view.routeview.MainActivity;
import com.smart.view.routeview.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(TestActivity.this, "click btn", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mCustomScrollViewGroup.setOnScrollListener(new CustomScrollViewGroup.OnScrollListener() {
            ...
            public void onScroll(float distanceX, float distanceY) {
                ...
                //.d(TAG, "onScroll distanceX = " + distanceX + " , distanceY = " + distanceY + ", currentTransY = " + currentTransY);
            }
            ...
            public void onFling(boolean isFlingUp) {
                ...
                //.d(TAG, "onFling isFlingUp = " + isFlingUp);
                if (isFlingUp) {
                    animatorScrollUp();
                } else {
                    animatorScrollDowm();
